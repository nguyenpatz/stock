...
<div class="container mt-4">
	<div class="container row rounded border p-4">
		<div class="col-2">
			<a href="/invoice/edit/{{$invoices->ivid}}"><button
					class="btn btn-info" style="width: 70px">Edit</button></a> <a
				href="/invoice_delete/{{$invoices->ivid}}"><button
					class="btn btn-danger">Unlink</button></a>
		...
		<div class="col-2 align-self-center">
			<div
				class="bg-light rounded-circle d-flex justify-content-center py-3">{{$invoices->state}}</div>
		</div>
	</div>
	<div class="container mt-2">
		...
		<div class="my-5">
			<div>
				Total Payment: <span class="h3 row ml-2">{{ $invoices->total_payment
					}}
					<p class="ml-1">VND</p>
				</span>
			</div>
